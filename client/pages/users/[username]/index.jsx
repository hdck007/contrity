  ...
  return (
    ...
    <div className="flex flex-row justify-between">
      ...
      <span className="flex items-center" >
        <button className="hover:bg-purple-400 btn btn-ghost h-100"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-2">
